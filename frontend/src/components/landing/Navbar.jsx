    ...
    <nav className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className="text-lg sm:text-xl font-semibold tracking-tight text-slate-900">MindSense <span className="text-gradient">AI</span></span>
        </Link>
        ...
        {/* Mobile Menu Toggle */}
        <button 
          className="md:hidden inline-flex h-11 w-11 items-center justify-center rounded-xl text-slate-600 hover:bg-white/70 hover:text-slate-900"
